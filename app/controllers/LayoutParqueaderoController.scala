...
/**
  ...
  */
@Singleton
class LayoutParqueaderoController  @Inject()(cc: ControllerComponents) (implicit assetsFinder: AssetsFinder) extends AbstractController(cc) {

  val logger = play.api.Logger(getClass)

  // Home page that renders template
  def indexlayout = Action { implicit request: Request[AnyContent] =>
    Ok(views.html.layoutparqueadero())
  }
